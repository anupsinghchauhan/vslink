                                                ...
                                                <?php 
                                                    ...
                                                    ?>
                                                                    <tr>
                                                                        ...
                                                                        <td width=""><?= $value->phone; ?></td>
                                                                        <td width=""><?= $value->subject; ?></td>
                                                                        <td width=""><?= $value->message; ?></td>
                                                                        <td width=""><?= date('d-M-Y',strtotime($value->added_on)); ?></td>
                                                                        <td width=""><?= form_open('admin/do_reply', ['class' => 'needs-validation', 'novalidate' => '', 'autocomplete' => 'off']); ?><input type="hidden" name="date" value="<?= $value->added_on; ?>"><input type="hidden" name="name" value="<?= $value->name; ?>"><input type="hidden" name="email_address" value="<?= $value->email; ?>"><textarea name="reply_to_query" placeholder="Reply.." class="form-control"></textarea></td>
