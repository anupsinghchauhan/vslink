    ...
    <section class="padding-top-200 padding-bottom-200 pos-rel oh">

        <div class="container">         
                <header class="page-header g" style="padding: 20px 0px;">
                  <div class="g12-xs g9-md text-center">
                    <h5 class="f1 cl-gray-1" itemprop="name">Our Blogs</h5>
                  </div>
                </header>
                
                <section class="page-section g text-center">
