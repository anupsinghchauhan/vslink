    ...
    <section class="padding-top padding-bottom pos-rel oh">

        <div class="container">         
                <header class="page-header g" style="padding: 20px 0px;">
                  <div class="g12-xs g9-md">
                    <h5 class="f1 cl-gray-1" itemprop="name">Privacy Policy</h5>
                    <p class="page-header__description m0 f1 cl-white" itemprop="description">The fine print</p>
                  </div>
                </header>
                
                <section class="page-section g">
                  <div class="g12-xs g9-xl mt32">
                    <h6 class="f5 cl-orange">Introduction</h6>
                    ...
                    <ol>
                      <li>
                        <h6 class="f5 cl-orange" id="childrens-privacy">Children's Privacy</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="information-provided-directly-by-you">Information Provided Directly By You</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="information-collected-through-your-use-of-our-services">Information Collected Through Your Use of Our Services</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="information-collected-from-other-sources">Information Collected From Other Sources</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="information-third-parties-provide">Information Third Parties Provide</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="aggregated-data">Aggregated Data</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="cookies-log-files-and-anonymous-identifiers">Cookies, Log Files and Anonymous Identifiers</h6>
                        <ol>
                          <li>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="device-information">Device Information</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="location-information">Location Information</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="protective-measures-we-use">Protective Measures We Use</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="the-legal-basis-for-collection-and-processing-of-your-personal-information">The Legal Basis For Collection and Processing of Your Personal Information</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="how-we-use-information-we-collect">How We Use Information We Collect</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="how-we-share-information-we-collect">How We Share Information We Collect</h6>
                        <ol>
                          <li>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="sharing-information-with-law-enforcement">Sharing Information With Law Enforcement</h6>
                        <ol>
                          <li>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="social-media-sharing">Social Media Sharing</h6>
                        <p></p>
                        <ol>
                          <li>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="analytic-services-provided-by-others">Analytic Services Provided By Others</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="links-to-third-party-websites">Links to Third-Party Websites</h6>
                        <ol>
                          <li>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="do-not-track-settings">Do Not Track Settings</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="international-privacy-policies">International Privacy Policies</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="account-information">Account Information</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="promotional-information-opt-out">Promotional Information Opt Out</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange" id="your-access-and-rights-to-your-personal-information">Your Access and Rights to Your Personal Information</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange">Your California Privacy Rights</h6>
                        <p></p>
                        <ol>
                          <li>
                      ...
                      <li>
                        <h6 class="f5 cl-orange">Our Information Retention Policy</h6>
                      ...
                      <li>
                        <h6 class="f5 cl-orange">Contact Us</h6>
                        ...
                        <p>Contact: Privacy Officer<br>Email: <a href="mailto:legal@wasai.co">legal@wasai.co</a><br>Office: 165 11th St, San Francisco, CA 94103</p>
                      </li>
                    </ol>
                  </div>
                </section>
