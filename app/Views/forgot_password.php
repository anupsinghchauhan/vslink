                ...
                <div class="fxt-inner-wrap fxt-transformX-R-50 fxt-transition-delay-3 login-form">
                        ...
                        <div class="row login-form-row">
                            ...
                            <div class="col-lg-7 col-md-12 col-sm-12">
                               ...
                               <?= form_open('auth/doget_pwdlink', ['class' => 'needs-validation', 'novalidate' => '', 'autocomplete' => 'off']); ?>

                                    <div class="form-group">

                                        <input type="email" id="email" class="form-control" name="emailid" placeholder="Enter Email address" required="required">
